...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: '/fixed-swap', icon: ArrowRightLeft, label: 'Fixed Swap' },
    ...
    { href: '/program-funding', icon: Coins, label: 'Program Funding' },
    { href: '/multihub-admin', icon: ShieldCheck, label: 'Multihub Admin' },
